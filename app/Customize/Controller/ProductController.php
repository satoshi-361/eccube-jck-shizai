...
class ProductController extends AbstractController
{
     ...
     * 商品一覧画面.
     *
     * @Route("category02/{id}", name="category02", methods={"GET"})
     * @Template("Product/category02.twig")
     */
    public function category02(Request $request, PaginatorInterface $paginator, $id = null)
    {
        // Doctrine SQLFilter
        if ($this->BaseInfo->isOptionNostockHidden()) {
            $this->entityManager->getFilters()->enable('option_nostock_hidden');
        ...
        foreach($Category->getProductCategories() as $ProductCategory) {
          if ($ProductCategory->getProduct()->getStatus()->getId() == ProductStatus::DISPLAY_SHOW)
              array_push($query, $ProductCategory->getProduct());
        }
